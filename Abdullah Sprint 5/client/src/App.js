...
import ConsultancyApplyForTasks from './components/ConsultancyApplyForTasks'
import ConsultancyViewTasks from './components/ConsultancyViewTasks'
      ...
      <Router>
       <div className="App">
          <div>
            ...
            <Route exact path="/consultancyApplyForTasks" component={ConsultancyApplyForTasks} />
            <Route exact path="/consultancyViewTasks" component={ConsultancyViewTasks} />
          </div>
       </div>
       </Router>
    );
